...
private extension KMJourneyCardCell {
    ...
    func layoutViews() {
        NSLayoutConstraint.activate([
            ...
            NSLayoutConstraint(item: cardImageView, attribute: .height, relatedBy: .equal, toItem: cardImageView, attribute: .width, multiplier: 0.7, constant: 0.0),
//            cardImageView.bottomAnchor.constraint(equalTo: footerView.bottomAnchor),
